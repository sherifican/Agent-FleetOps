...
def main(argv=None):
    ...
    print("=" * 104)
    print("PROVENANCE, stated honestly: the 2% threshold's first appearance committed HERE (74876aa) is in")
    print("the same commit as a favourable cascade result, and no earlier artifact exists in git or memory.")
    print("The hash this line used to give resolved to nothing in this repository at all, which is a poor")
    print("way to open a paragraph about provenance; it named a commit from before the export. So")
