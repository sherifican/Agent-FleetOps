...
peak = [
    ...
    ("qwen3.6:35b-a3b",       114.4, "qwen",     "23 GB · Q4_K_M · MoE A3B · ollama · single run"),
    ("qwen3-coder:30b",       108.1, "qwen",     "18 GB · Q4_K_M · 30.5B dense · spec-decode · best of 2"),
    ("GLM-4.7-Flash",         105.0, "glm",      "18 GB · Q4_K_M · llama-server · best of 2"),
    ("gemma4:26b-a4b-it-qat", 100.0, "gemma",    "15 GB · Q4_0 QAT · 25.2B MoE A4B · best of 3"),
    ...
    ("gemma4:31b-it-qat",      21.0, "gemma",    "18 GB · Q4_0 QAT · 30.7B DENSE · best of 3"),
]
...
panel1 = {
    "title": {"text": "Local model throughput — measured on one dual-RTX 5060 Ti box",
              "subtitle": ["Best run per model. Mixed serving stacks (ollama · llama.cpp · llama-server) — indicative, not a controlled cross-stack benchmark.",
                           "Under each model name: weights · quantisation · architecture · how many runs it is the best of."],
...
panel3 = {
    "title": {"text": "Weights on disk vs VRAM actually occupied (both cards summed)",
...
def _verify_against_csv():
    ...
    if bad:
        ...
        sys.exit(1)
    print(f"consistency gate: OK — {len(peak)} chart rows match the CSV record")
